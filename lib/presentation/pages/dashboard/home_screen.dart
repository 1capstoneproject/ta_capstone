                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Header(
                              name: controller.prefs.userInfo["name"]??"User"
                            ),
                          ],
                        ),
                        const SizedBox(height: 10),
                        ...
                        Obx(() => Visibility(
                            visible: controller.eventList.length != 0,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                ...
                                Obx(() => controller.isLoading.value ? Shimmer.fromColors(
                                  child: Container(
                                    width: 1.sw,
                                    height: 240.sp,
                                  ),
                        ...
                        SizedBox(height: 8.h),
                        Obx(() => Visibility(
                          visible: controller.packageList.length != 0,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                        ...
                        Obx(() => Visibility(
                          visible: controller.productList.length != 0,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Text(
                                'Explore Tempat Wisata',
                                style: titleMedium,
                              ),
                              Obx(() => GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  var popular = controller.productList[index];
                                  return CardWisata(
                                    id: popular['id'],
